...
x2 = x1**5 #degree of polynomial term (e.g. square, cube or higher) of the data - this is your 2nd dimension or "basis expansion" \Phi(X). Try some big values to see what happens
X_nonlin = np.concatenate((np.ones((100,1)), x1, x2),axis=1) #Add ones for the intercept and combine everything into X_nonlin=[ones X \Phi(X)] (dim=100x3)
