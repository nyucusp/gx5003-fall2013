...
createCommand = "CREATE table ZipCodes_table (name int not null, zip_code int not null, area int not null, population_perZip int not null, primary key(name))"
cur.execute(createCommand)

createCommand = "CREATE table Incidents_table (incident_address varchar(255), incident_zip int not null, name int not null, primary key(incident_address))"
cur.execute(createCommand)
