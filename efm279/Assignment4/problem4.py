...
addresses="SELECT coursedb.incidents.address from (select distinct coursedb.boroughs.zip from coursedb.boroughs where coursedb.boroughs.bname='Manhattan') z, \
