...
#Anotations 
#by looking at the histogram you learn that the first and second
#assignment and little work, the third looks like it had more work.
#the 4,5, and 6 had the least work.
#there was less action on the first due date than the others,the third assignmnet the timestamp increased immensely 
#showing that the activity increased. the fourth assignmnet also had high timestamps
#the 6th had less the day it was due, but then the 5th went back to being more.
