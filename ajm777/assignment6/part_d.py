...
def fit_plot_unlabeled_data(unlabeled_data_x, labeled_data_x, labeled_data_y, fit_order, data_type):
...
fit_plot_unlabeled_data(unlabeled_pop, pop, num_inc, 3, 'Population')
fit_plot_unlabeled_data(unlabeled_zips, zips, num_inc, 9, 'Zip Code')
